...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self setAppearanceProxy];
	
    KFRootViewController *rootViewController = [[KFRootViewController alloc] init];
	self.window.rootViewController = rootViewController;
	[rootViewController release];
	
	[[KFStoreManager sharedManager] start];
...
{
	KFRootViewController *root = (KFRootViewController *)self.window.rootViewController;
    [root didBecomeActive];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Kaffeine" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Kaffeine.sqlite"];
